/**
 * @file parser.c
 * @brief This file contains the implementation of a simple parser for a programming language.
 * 
 * The parser processes tokens generated by a lexer and constructs an Abstract Syntax Tree (AST)
 * representing the structure of the source code. This file includes function definitions for
 * handling various types of statements, expressions, and error handling.
 */
...
/* Global variables representing the current token index and the maximum token index */
int curtoken;
int maxtoken;

/**
 * @brief Error handling function that prints an error message and exits the program.
 * 
...
/**
 * @brief Parses a list of declarations.
 * 
 * This function processes tokens that represent a list of declarations, such as variable or function declarations.
 * It constructs and returns an AST node representing the parsed declaration list.
 * 
 * @param token Array of tokens.
 * @return Pointer to the AST node representing the declaration list.
 */
struct AST_node_declaration_list *declaration_list(struct Token *token) {
 ...
 * 
 * This function processes tokens that represent a single declaration, such as a variable or function declaration.
 * It constructs and returns an AST node representing the parsed declaration.
 * 
 * @param token Array of tokens.
 ...
 * 
 * This function processes tokens that represent a function declaration.
 * It constructs and returns an AST node representing the parsed function declaration.
 * 
 * @param token Array of tokens.
 * @return Pointer to the AST node representing the function declaration.
 */
struct AST_node_func_dec *func_declaration(struct Token *token) 
{
 ...
 * 
 * This function processes tokens that represent a variable declaration.
 * It constructs and returns an AST node representing the parsed variable declaration.
 * 
 * @param token Array of tokens.
 ...
 * 
 * This function processes tokens that represent function parameters.
 * It constructs and returns an AST node representing the parsed parameters.
 * 
 * @param token Array of tokens.
 * @return Pointer to the AST node representing the parameters.
 */
struct AST_node_func_paras *paras(struct Token *token) {
 ...
 * 
 * This function processes tokens that represent a statement.
 * It constructs and returns an AST node representing the parsed statement.
 * 
 * @param token Array of tokens.
 ...
 * @brief Parses a statement.
 * 
 * This function processes tokens that represent a general statement.
 * It constructs and returns an AST node representing the parsed statement.
 * 
 * @param token Array of tokens.
 * @return Pointer to the AST node representing the statement.
 ...
 * 
 * This function processes tokens that represent a declaration statement.
 * It constructs and returns an AST node representing the parsed declaration statement.
 * 
 * @param token Array of tokens.
 * @return Pointer to the AST node representing the declaration statement.
 */
struct AST_node_state_dec *state_dec(struct Token *token)
{
 ...
 * 
 * This function processes tokens that represent a return statement.
 * It constructs and returns an AST node representing the parsed return statement.
 * 
 * @param token Array of tokens.
 * @return Pointer to the AST node representing the return statement.
 */
struct AST_node_state_return *state_return(struct Token *token)
{
 ...
 * 
 * This function processes tokens that represent a let-statement.
 * It constructs and returns an AST node representing the parsed let-statement.
 * 
 * @param token Array of tokens.
 * @return Pointer to the AST node representing the let-statement.
 */
struct AST_node_state_let *state_let(struct Token *token)
{
 ...
 * 
 * This function processes tokens that represent a function call expression.
 * It constructs and returns an AST node representing the parsed function call.
 * 
 * @param token Array of tokens.
 * @return Pointer to the AST node representing the function call.
 */
struct AST_node_func_call *expr_func(struct Token *token) {
 ...
 * 
 * This function processes tokens that represent an if-statement.
 * It constructs and returns an AST node representing the parsed if-statement.
 * 
 * @param token Array of tokens.
 ...
 * 
 * This function processes tokens that represent a boolean expression.
 * It constructs and returns an AST node representing the parsed boolean expression.
 * 
 * @param token Array of tokens.
 * @return Pointer to the AST node representing the boolean expression.
 */
struct AST_node_condition *expr_bool(struct Token *token) {
 ...
 * 
 * This function processes tokens that represent a for-statement.
 * It constructs and returns an AST node representing the parsed for-statement.
 * 
 * @param token Array of tokens.
 * @return Pointer to the AST node representing the for-statement.
 */
struct AST_node_state_for *state_for(struct Token *token) {
 ...
 * 
 * This function processes tokens that represent the entire program.
 * It constructs and returns an AST node representing the parsed program.
 * 
 * @param token Array of tokens.
 * @param program_node Pointer to the program node to be populated.
 * @return Pointer to the AST node representing the program.
 */
