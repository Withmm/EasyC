/*
 * lex.c
 * This file contains the implementation of the lexical analysis functions.
 * It includes the lexer function that tokenizes the input source code and helper functions 
 * for identifying different types of tokens such as keywords, operators, and delimiters.
 */
 ...
 * Function: lexer
 * ----------------
 * The lexer function tokenizes the input source code.
 *
 *  file_lexeme: The input source code as a string.
 *  maintoken: An array to store the tokens generated by the lexer.
 *
 ...
 *
 *  returns: 1 if the character is a letter or underscore, 0 otherwise.
 */
 ...
 *
 *  c: The character to check.
 *  delimiter: The array of delimiter characters.
 *
 ...
 *  keyword: The array of keyword strings.
 *
...
/*
 * Function: is_loperator
 * ----------------------
 * Checks if a character is the start of a logical operator.
 *
 *  c: The character to check.
 *  loperator: The array of logical operator strings.
 *
 *  returns: 1 if the character is the start of a logical operator, 0 otherwise.
 */
 ...
 *  loperator: The array of operator strings.
 *
 *  returns: 1 if the string is an operator, 0 otherwise.
 */
